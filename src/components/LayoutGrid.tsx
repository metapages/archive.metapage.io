...
export const getLayout = (metapageDefinition:MetapageDefinition) :MetapageLayoutGrid|undefined => {
    if (metapageDefinition?.meta?.layouts?.[LayoutName]) {
        return metapageDefinition.meta.layouts[LayoutName] as MetapageLayoutGrid;
    }
}

export const generateDefaultLayout = (metapage :Metapage) :MetapageLayoutGrid => {
