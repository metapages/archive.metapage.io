...
type DeployTargetType = "glitch" | "browser";
// values acted on: [glitch | lib]
const DEPLOY_TARGET = process.env.DEPLOY_TARGET as DeployTargetType || "browser";
...
export default defineConfig(({ command, mode }) => ({
  ...
  resolve: {
    alias: {
      ...
      // "@metapages/metapage-grid-react": resolve(__dirname, "./src/lib"),
    },
  },
  plugins: [react()],
  build: {
